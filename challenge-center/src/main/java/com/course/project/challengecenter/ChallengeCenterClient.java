...
@Slf4j
@Service
public class ChallengeCenterClient {
    private final RabbitTemplate rabbitTemplate;
    private static final String ENDPOINT = "/challenge";
    ...
    @Autowired
    public ChallengeCenterClient(RabbitTemplate rabbitTemplate, EurekaClient registry) {
